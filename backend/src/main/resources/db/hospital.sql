...
CREATE TABLE appointments (
                              ...
                              appointment_status ENUM('pending','booked','cancelled','completed','no_show','pending_patient_confirm','waiting_patient_action','converted') DEFAULT 'pending' COMMENT '挂号状态:已下单未支付，挂号成功，患者或管理员取消，就诊完成，未到诊',
